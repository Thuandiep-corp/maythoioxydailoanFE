    ...
    <header className="font-sans">
      ...
      <div className="w-full bg-white py-4 shadow-sm relative z-50">
        <div className="container mx-auto px-4 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-1 justify-end max-w-2xl ml-auto">
            ...
            <button className="hidden md:flex items-center gap-2 border border-gray-200 rounded-full px-5 py-2.5 hover:border-[#408ebd] hover:text-[#408ebd] transition-colors relative group shrink-0">
