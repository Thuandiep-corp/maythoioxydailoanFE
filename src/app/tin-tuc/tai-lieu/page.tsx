        ...
        <div className="max-w-[960px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
            {documents.map((doc, index) => (
              <div 
                key={index} 
                className="group bg-white p-5 rounded-xl border border-gray-200 hover:shadow-md hover:border-[#408ebd]/30 transition-all cursor-pointer flex items-start gap-4"
              >
